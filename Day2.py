...
def Valid_ID(stringy):
    ...
    for i in range(len(game_records)):
        ...
        for j in range(len(i_game_results)):
            ...
            if ((int)(i_game_number_of_cubes[0]) > max_red) and i_game_number_of_cubes[1] == "red":
                impossible_game = True
            if ((int)(i_game_number_of_cubes[0]) > max_green) and i_game_number_of_cubes[1] == "green":
                impossible_game = True
            if ((int)(i_game_number_of_cubes[0]) > max_blue) and i_game_number_of_cubes[1] == "blue":
                impossible_game = True
    #...
